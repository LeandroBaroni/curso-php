...
if(count($_POST) > 0){
    ...
    //Abaixo a outra função que poderia ter sido feita
    //if(isset($_POST['nome']));
    if(trim($dados['nome']) === ""){
    ...
    if(isset($dados['nascimento'])){
        ...
        if(!$data){
            $erros['nascimento'] = 'Data de Nascimento é obrigatório no formato dd/mm/aaaa';
        }
    }
...
<form action="/curso-php/exercicio.php" method="get">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-2">
            <button class="btn btn-sucess mb-4">Consultar</button>
        </div>
    </div>
</form>
...
<form action="#" method="post">
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-3">
            ...
            <input type="date" class="form-control <?= $erros['nascimento'] ? 'is-invalid' : '' ?>" id="nascimento" name="nascimento" placeholder="Nascimento" value="<?= $dados['nascimento'] ?>">
            <div class="invalid-feedback">
                <?= $erros['nascimento'] ?>
            </div>
        </div>
    ...
    <button class="btn btn-primary btn-lng">Enviar</button>
</form>
